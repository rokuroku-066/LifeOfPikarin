...
namespace Terrarium.Sim
{
    ...
    public sealed class SpeciesConfig
    {
        ...
        public float ReproductionEnergyThreshold { get; set; } = 15f;
        public float AdultAge { get; set; } = 8f;
        public float MaxAge { get; set; } = 120f;
    ...
    public sealed class FeedbackConfig
    {
        ...
        public float DiseaseProbabilityPerNeighbor { get; set; } = 0.0015f;
    }
}
